...
def render_job_search():
    """Render job search page with real-time job portals and official career links"""
    from ui_components import back_to_hub_button
    back_to_hub_button()

    st.title("🔍 Live Job & Internship Search")
    st.markdown("Search verified job postings across top career portals or apply directly to official company career sites.")
